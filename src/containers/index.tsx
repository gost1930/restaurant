...
export {default as GeneralBanner} from "./GreneralBanner/GeneralBanner";
export {default as AllBranches} from "./AllBranches/AllBranches";
export {default as FormLogin} from "./FormLogin/FormLogin"
export {default as FormRegister} from "./FormRegister/FormRegister"
export {default as GetBranch} from "./BrancheContainer/GetBranch"